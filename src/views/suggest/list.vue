<template>
  <div v-loading="loading" class="app-container">
    ...
    <el-table :data="table_data.data" style="width: 100%">
      ...
      <el-table-column prop="suggest_time" label="建议时间" align="center"/>
      <el-table-column prop="sort" label="操作" width="140" align="center">
...
export default {
  ...
  methods: {
    ...
    get_data() {
      this.loading = true
      delete this.param.t
      this.$request.post('/admin/suggest/getListData', this.param).then((res) => {
